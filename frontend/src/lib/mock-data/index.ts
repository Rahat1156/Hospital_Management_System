...
export const MOCK_ALERTS: Alert[] = [
  ...
  },
  {
    ...
    recipients: [
      { user_id: 'user-admin-001', user_name: 'Md. Masfiqur Rahman Nehal', role: 'hospital_admin', contact: 'admin@demo.hms.com.bd', acknowledged: false },
    ],
...
export const MOCK_EMERGENCIES: EmergencyRequest[] = [
  {
    ...
    dispatcher_id: 'user-admin-001', dispatcher_name: 'Md. Masfiqur Rahman Nehal',
